...
- `update <id>`: 譌｢蟄倥・謚慕ｨｿ繧呈峩譁ｰ縺励∪縺吶・  - `wpai posts push 123 [--title <TITLE>] [--content <CONTENT> | --content-file <PATH>] [--status <STATUS>] [--edit-mode <markdown|html>] [--categories <IDs>] [--tags <IDs>] [--featured-media <ID>]`
